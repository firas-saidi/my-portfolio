    ...
    <HomeSection>
            <div className="container">
                <Information>
                    ...
                    <HomeBtn    href = "https://drive.google.com/file/d/1ZPD66mzyNNE_E_A1jVkc7y-RTPMfQ94C/view?usp=sharing"  target="_blank" rel="noopener noreferrer"><img className='my-btn'  src ={img} alt =''/>Download my resume</HomeBtn> <i class="bi bi-download"></i>
                </Information>
            </div>
        </HomeSection>
  )
