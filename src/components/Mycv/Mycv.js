    ...
    <HomeSection>
            <div className="container">
                <Information>
                    ...
                    <HomeBtn    href = "https://drive.google.com/file/d/1K8erFjN0n0uy7TOz7rpuMKpqRCzzpUUk/view?usp=share_link"  target="_blank" rel="noopener noreferrer"><img className='my-btn'  src ={img} alt =''/>Download Cv</HomeBtn> <i class="bi bi-download"></i>
                </Information>
            </div>
        </HomeSection>
  )
